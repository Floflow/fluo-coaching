      ...
      <div className="container">
        <div style={{ maxWidth: '720px', position: 'relative', zIndex: 1 }}>
          ...
          <p className="hero-sub fade-in fade-in-delay-2" style={{
            ...
            Ce qui semblait juste hier ne te ressemble plus tout à fait aujourd&rsquo;hui. Je te propose ce bilan de compétences éligible au CPF qui t&rsquo;aidera à y voir plus clair et décider sereinement de la suite.
          </p>
